...
const Cart = () => {
    ...
    const createOrder = async (data)=> {
        try {
            const res = await axios.post("https://restaurant-silk-xi.vercel.app/api/orders", data);
            if (res.status === 201) {
                dispatch(reset());
            ...
            <div className={styles.wrapper}>
               ...
               {open ? (
                   <div className={styles.paymentMethods}>
                    ...
                    <PayPalScriptProvider
                       options={{
                           "client-id": "AVQVNmFgFRMxLqjKdbLzHINQkbJgXnLQa3_4MtaP5qVOq55e4a2C7djKwYLbYdDd0tNwsQd9y6cY07ot",
                           components: "buttons",
                       currency: "USD",
