    ...
    const handleCreate = async()=>{
        ...
        try {
            const uploadRes = await axios.post(
                "https://api.cloudinary.com/v1_1/dxzdjeoae/image/upload",
                data
            )
            ...
            await axios.post("https://restaurant-silk-xi.vercel.app/api/products", newProduct);
            setClose(true)
        } catch (err) {
            console.log(err)
        }
    ...
    <div className={styles.container}>
        ...
        <div className={styles.item}>
            ...
            <div className={styles.priceContainer}>
                ...
                <input className={`${styles.input} ${styles.inputSm}`} type="number" placeholder="Meduim" onChange={(e)=>{changePrice(e,1)}} />
